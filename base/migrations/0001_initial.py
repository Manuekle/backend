# Generated by Django 3.1.4 on 2022-07-07 20:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Categories',
            fields=[
                ('name', models.CharField(blank=True, choices=[('kodomo', 'Kodomo '), ('shonen', 'Shonen'), ('shojo', 'Shojo'), ('seinen', 'Seinen'), ('josei', 'Josei')], max_length=200)),
        ...
        migrations.CreateModel(
            name='Editorials',
            fields=[
                ('name', models.CharField(blank=True, choices=[('norma editorial', 'Norma Editorial'), ('editorial ivrea', 'Editorial Ivrea'), ('dolmen editorial', 'Dolmen Editorial'), ('editorial kamite', 'Editorial Kamite'), ('editorial panini', 'Editorial Panini'), ('ecc ediciones', 'ECC Ediciones')], max_length=200, null=True)),
                ('createdAt', models.DateTimeField(auto_now_add=True)),
                ('_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('photo', models.ImageField(blank=True, default='/avatar.jpg', null=True, upload_to='')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
