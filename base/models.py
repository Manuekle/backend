...
class Editorials(models.Model):
    editorials = (
        ...
        ('kamite', 'Kamite'),
        ('panini', 'Panini'),
        ('ecc ediciones', 'ECC Ediciones'),
    )

    name = models.CharField(
        max_length=200, choices=editorials, null=True, blank=True)
    createdAt = models.DateTimeField(auto_now_add=True)
    _id = models.AutoField(primary_key=True, editable=False)
...
class ShippingAddress(models.Model):
    ...
    country = models.CharField(max_length=200, null=True, blank=True , choices=countries)
